...
// @generated from protobuf file "user.proto" (package "pb", syntax proto3)
// tslint:disable
...
export interface User {
    ...
    email: string;
    /**
     * @generated from protobuf field: google.protobuf.Timestamp password_change_at = 4;
     */
...
class User$Type extends MessageType<User> {
    constructor() {
        super("pb.User", [
            ...
            { no: 4, name: "password_change_at", kind: "message", T: () => Timestamp },
            { no: 5, name: "created_at", kind: "message", T: () => Timestamp }
        ]);
    }
    create(value?: PartialMessage<User>): User {
        const message = { username: "", fullName: "", email: "" };
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string email */ 3:
                    ...
                    break;
                case /* google.protobuf.Timestamp password_change_at */ 4:
                    message.passwordChangeAt = Timestamp.internalBinaryRead(reader, reader.uint32(), options, message.passwordChangeAt);
                    break;
    ...
    internalBinaryWrite(message: User, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.passwordChangeAt)
            Timestamp.internalBinaryWrite(message.passwordChangeAt, writer.tag(4, WireType.LengthDelimited).fork(), options).join();
